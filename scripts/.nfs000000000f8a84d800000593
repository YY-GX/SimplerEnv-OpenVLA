...
#declare -a arr=("/mnt/bum/yufang/projects/openvla/runs/1.1.0/openvla-7b+droid+b8+lr-0.0005+lora-r32+dropout-0.0--5000_chkpt")
#declare -a arr=("/mnt/bum/yufang/projects/openvla/runs/1.1.0/openvla-7b+droid+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--1000_chkpt")
#declare -a arr=("/mnt/bum/yufang/projects/openvla/runs/1.1.0/openvla-7b+droid+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--3000_chkpt" "/mnt/bum/yufang/projects/openvla/runs/1.1.0/openvla-7b+droid+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--2000_chkpt" "/mnt/bum/yufang/projects/openvla/runs/1.1.2/openvla-7b+droid+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--30000_chkpt" "/mnt/bum/yufang/projects/openvla/runs/1.1.2-bs64/openvla-7b+droid+b8+lr-0.0005+lora-r32+dropout-0.0--15000_chkpt")
...
declare -a arr=("/mnt/bum/yufang/projects/openvla/runs/1.1.5-rollout-0.1-aug/carrot-1.1.5-openvla-7b+droid_rollout_0.1+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--10000_chkpt")
declare -a arr=("/mnt/bum/yufang/projects/openvla/runs/1.1.5-rollout-0.3-aug/carrot-1.1.5-openvla-7b+droid_rollout_0.3+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--10000_chkpt")
declare -a arr=("/mnt/bum/yufang/projects/openvla/runs/1.1.5-rollout-0.5-aug/carrot-1.1.5-openvla-7b+droid_rollout_0.5+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--10000_chkpt")
